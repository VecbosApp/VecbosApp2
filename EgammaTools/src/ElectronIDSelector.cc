...
ElectronCollection ElectronIDSelector::output() {
  ...
  else if(algo_.compare("mva_id")==0)      return output_cuts_id();
  else if(algo_.compare("mva_iso")==0)     return output_cuts_iso();
  else if(algo_.compare("mva_convrej")==0) return output_cuts_convrej();
  else if(algo_.compare("mva_ip")==0)      return output_cuts_ip();
  else if(algo_.compare("mva")==0)         return output_cuts();
