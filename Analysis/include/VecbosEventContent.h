...
public :
   ...
   Float_t         thetaEle[500];   //[nEle]
   Float_t         etaEle[500];   //[nEle]
   Float_t         phiEle[500];   //[nEle]
   Float_t         pxEle[500];   //[nEle]
   Float_t         pyEle[500];   //[nEle]
   Float_t         pzEle[500];   //[nEle]
   Float_t         vertexXEle[500];   //[nEle]
   Float_t         vertexYEle[500];   //[nEle]
   Float_t         vertexZEle[500];   //[nEle]
   Int_t           fiducialFlagsEle[500];   //[nEle]
   Int_t           recoFlagsEle[500];   //[nEle]
   Float_t         trackMomentumErrorEle[500];   //[nEle]
   Int_t           superClusterIndexEle[500];   //[nEle]
   Int_t           PFsuperClusterIndexEle[500];   //[nEle]
   Int_t           trackIndexEle[500];   //[nEle]
   Int_t           gsfTrackIndexEle[500];   //[nEle]
   Float_t         convDistEle[500];   //[nEle]
   Float_t         convDcotEle[500];   //[nEle]
   Float_t         convRadiusEle[500];   //[nEle]
   Int_t           convTrackIndexEle[500];   //[nEle]
   Int_t           scPixChargeEle[500];   //[nEle]
   Bool_t          hasMatchedConversionEle[500];   //[nEle]
   Int_t           classificationEle[500];   //[nEle]
   Float_t         fbremEle[500];   //[nEle]
   Int_t           nbremsEle[500];   //[nEle]
   Float_t         hOverEEle[500];   //[nEle]
   Float_t         eSuperClusterOverPEle[500];   //[nEle]
   Float_t         eSeedOverPoutEle[500];   //[nEle]
   Float_t         eEleClusterOverPoutEle[500];   //[nEle]
   Float_t         deltaEtaAtVtxEle[500];   //[nEle]
   Float_t         deltaPhiAtVtxEle[500];   //[nEle]
   Float_t         deltaEtaAtCaloEle[500];   //[nEle]
   Float_t         deltaPhiAtCaloEle[500];   //[nEle]
   Float_t         deltaEtaEleClusterTrackAtCaloEle[500];   //[nEle]
   Float_t         deltaPhiEleClusterTrackAtCaloEle[500];   //[nEle]
   Float_t         dr03TkSumPtEle[500];   //[nEle]
   Float_t         dr03EcalRecHitSumEtEle[500];   //[nEle]
   Float_t         dr03HcalTowerSumEtEle[500];   //[nEle]
   Float_t         dr04TkSumPtEle[500];   //[nEle]
   Float_t         dr04EcalRecHitSumEtEle[500];   //[nEle]
   Float_t         dr04HcalTowerSumEtEle[500];   //[nEle]
   Float_t         dr03HcalTowerSumEtFullConeEle[500];   //[nEle]
   Float_t         dr04HcalTowerSumEtFullConeEle[500];   //[nEle]
   Float_t         pflowMVAEle[500];   //[nEle]
   Float_t         mvaidnontrigEle[500];   //[nEle]
   Float_t         mvaidtrigEle[500];   //[nEle]
   Float_t         mvaidisotrigEle[500];   //[nEle]
   Float_t         pfCombinedIsoEle[500];   //[nEle]
   Float_t         pfCandChargedIso03Ele[500];   //[nEle]
   Float_t         pfCandNeutralIso03Ele[500];   //[nEle]
   Float_t         pfCandPhotonIso03Ele[500];   //[nEle]
   Float_t         pfCandChargedIso04Ele[500];   //[nEle]
   Float_t         pfCandNeutralIso04Ele[500];   //[nEle]
   Float_t         pfCandPhotonIso04Ele[500];   //[nEle]
   Float_t         pfCandChargedDirIso04Ele[500];   //[nEle]
   Float_t         pfCandNeutralDirIso04Ele[500];   //[nEle]
   Float_t         pfCandPhotonDirIso04Ele[500];   //[nEle]
   Float_t         pfCandChargedPUIso03Ele[500];   //[nEle]
   Float_t         pfCandChargedPUIso04Ele[500];   //[nEle]
   Float_t         calibEnergyEle[500];   //[nEle]
   Float_t         calibEnergyErrorEle[500];   //[nEle]
   Int_t           nPho;
   Int_t           nPerPVPho;
   Int_t           chargePho[500];   //[nPho]
   Float_t         energyPho[500];   //[nPho]
   Float_t         thetaPho[500];   //[nPho]
   Float_t         etaPho[500];   //[nPho]
   Float_t         phiPho[500];   //[nPho]
   Float_t         pxPho[500];   //[nPho]
   Float_t         pyPho[500];   //[nPho]
   Float_t         pzPho[500];   //[nPho]
   Float_t         vertexXPho[500];   //[nPho]
   Float_t         vertexYPho[500];   //[nPho]
   Float_t         vertexZPho[500];   //[nPho]
   Int_t           fiducialFlagsPho[500];   //[nPho]
   Int_t           recoFlagsPho[500];   //[nPho]
   Int_t           superClusterIndexPho[500];   //[nPho]
   Int_t           PFsuperClusterIndexPho[500];   //[nPho]
   Float_t         hOverEPho[500];   //[nPho]
   Float_t         hTowOverEPho[500];   //[nPho]
   Float_t         dr03TkSumPtPho[500];   //[nPho]
   Float_t         dr03HollowTkSumPtPho[500];   //[nPho]
   Float_t         dr03EcalRecHitSumEtPho[500];   //[nPho]
   Float_t         dr03HcalTowerSumEtPho[500];   //[nPho]
   Float_t         dr04TkSumPtPho[500];   //[nPho]
   Float_t         dr04HollowTkSumPtPho[500];   //[nPho]
   Float_t         dr04EcalRecHitSumEtPho[500];   //[nPho]
   Float_t         dr04HcalTowerSumEtPho[500];   //[nPho]
   Float_t         chargedHadronIsoPho[500];   //[nPho]
   Float_t         neutralHadronIsoPho[500];   //[nPho]
   Float_t         photonIsoPho[500];   //[nPho]
   Int_t           hasPixelSeedPho[500];   //[nPho]
   Bool_t          hasMatchedConversionPho[500];   //[nPho]
   Float_t         dr02NeutralHadronPFIsoPho[500];   //[nPho]
   Float_t         dr02PhotonPFIsoPho[500];   //[nPho]
   Float_t         dr03NeutralHadronPFIsoPho[500];   //[nPho]
   ...
   Float_t         pxGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Float_t         pyGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Float_t         pzGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Int_t           vtxIndexGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Float_t         vtxWeightGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Float_t         impactPar3DGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Float_t         impactPar3DErrorGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Float_t         transvImpactParGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Float_t         transvImpactParErrorGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Float_t         impactPar3DBiasedGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Float_t         impactPar3DBiasedErrorGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Float_t         transvImpactParBiasedGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Float_t         transvImpactParBiasedErrorGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Float_t         chargeGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Float_t         ptErrorGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Float_t         trackValidHitsGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Float_t         trackLostHitsGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Float_t         trackNormalizedChi2GlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Int_t           qualityMaskGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Float_t         trackVxGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Float_t         trackVyGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Float_t         trackVzGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Float_t         d0GlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Float_t         d0ErrorGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Float_t         dzGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Float_t         dzErrorGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Int_t           pixelHitsGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Int_t           trackerLayersWithMeasurementGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Int_t           expInnerLayersGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Int_t           numberOfValidPixelBarrelHitsGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Int_t           numberOfValidPixelEndcapHitsGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Int_t           numberOfValidStripTIBHitsGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Int_t           numberOfValidStripTIDHitsGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Int_t           numberOfValidStripTOBHitsGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Int_t           numberOfValidStripTECHitsGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Int_t           numberOfValidMuonHitsGlobalMuonTrack[500];   //[nGlobalMuonTrack]
   Int_t           nSTAMuonTrack;
   Float_t         pxSTAMuonTrack[500];   //[nSTAMuonTrack]
   Float_t         pySTAMuonTrack[500];   //[nSTAMuonTrack]
   Float_t         pzSTAMuonTrack[500];   //[nSTAMuonTrack]
   Float_t         chargeSTAMuonTrack[500];   //[nSTAMuonTrack]
   Float_t         ptErrorSTAMuonTrack[500];   //[nSTAMuonTrack]
   Float_t         trackValidHitsSTAMuonTrack[500];   //[nSTAMuonTrack]
   Float_t         trackLostHitsSTAMuonTrack[500];   //[nSTAMuonTrack]
   Float_t         trackNormalizedChi2STAMuonTrack[500];   //[nSTAMuonTrack]
   Int_t           qualityMaskSTAMuonTrack[500];   //[nSTAMuonTrack]
   Float_t         trackVxSTAMuonTrack[500];   //[nSTAMuonTrack]
   Float_t         trackVySTAMuonTrack[500];   //[nSTAMuonTrack]
   Float_t         trackVzSTAMuonTrack[500];   //[nSTAMuonTrack]
   Float_t         d0STAMuonTrack[500];   //[nSTAMuonTrack]
   Float_t         d0ErrorSTAMuonTrack[500];   //[nSTAMuonTrack]
   Float_t         dzSTAMuonTrack[500];   //[nSTAMuonTrack]
   Float_t         dzErrorSTAMuonTrack[500];   //[nSTAMuonTrack]
   Int_t           pixelHitsSTAMuonTrack[500];   //[nSTAMuonTrack]
   Int_t           trackerLayersWithMeasurementSTAMuonTrack[500];   //[nSTAMuonTrack]
   Int_t           expInnerLayersSTAMuonTrack[500];   //[nSTAMuonTrack]
   Int_t           numberOfValidPixelBarrelHitsSTAMuonTrack[500];   //[nSTAMuonTrack]
   Int_t           numberOfValidPixelEndcapHitsSTAMuonTrack[500];   //[nSTAMuonTrack]
   Int_t           numberOfValidStripTIBHitsSTAMuonTrack[500];   //[nSTAMuonTrack]
   Int_t           numberOfValidStripTIDHitsSTAMuonTrack[500];   //[nSTAMuonTrack]
   Int_t           numberOfValidStripTOBHitsSTAMuonTrack[500];   //[nSTAMuonTrack]
   Int_t           numberOfValidStripTECHitsSTAMuonTrack[500];   //[nSTAMuonTrack]
   Int_t           numberOfValidMuonHitsSTAMuonTrack[500];   //[nSTAMuonTrack]
   Int_t           nPV;
   ...
   Int_t           nMuon;
   Int_t           chargeMuon[500];   //[nMuon]
   Float_t         energyMuon[500];   //[nMuon]
   Float_t         thetaMuon[500];   //[nMuon]
   Float_t         etaMuon[500];   //[nMuon]
   Float_t         phiMuon[500];   //[nMuon]
   Float_t         pxMuon[500];   //[nMuon]
   Float_t         pyMuon[500];   //[nMuon]
   Float_t         pzMuon[500];   //[nMuon]
   Float_t         vertexXMuon[500];   //[nMuon]
   Float_t         vertexYMuon[500];   //[nMuon]
   Float_t         vertexZMuon[500];   //[nMuon]
   Int_t           trackIndexMuon[500];   //[nMuon]
   Int_t           standAloneTrackIndexMuon[500];   //[nMuon]
   Int_t           combinedTrackIndexMuon[500];   //[nMuon]
   Int_t           muonIdMuon[500];   //[nMuon]
   Bool_t          pfmuonIdMuon[500];   //[nMuon]
   Int_t           typeMuon[500];   //[nMuon]
   Int_t           numberOfMatchesMuon[500];   //[nMuon]
   Float_t         sumPt03Muon[500];   //[nMuon]
   Float_t         emEt03Muon[500];   //[nMuon]
   Float_t         hadEt03Muon[500];   //[nMuon]
   Float_t         hoEt03Muon[500];   //[nMuon]
   Float_t         nTrk03Muon[500];   //[nMuon]
   Float_t         nJets03Muon[500];   //[nMuon]
   Float_t         sumPt05Muon[500];   //[nMuon]
   Float_t         emEt05Muon[500];   //[nMuon]
   Float_t         hadEt05Muon[500];   //[nMuon]
   Float_t         hoEt05Muon[500];   //[nMuon]
   Float_t         nTrk05Muon[500];   //[nMuon]
   Float_t         nJets05Muon[500];   //[nMuon]
   Float_t         pfCombinedIsoMuon[500];   //[nMuon]
   Float_t         pfCandChargedIso03Muon[500];   //[nMuon]
   Float_t         pfCandNeutralIso03Muon[500];   //[nMuon]
   Float_t         pfCandPhotonIso03Muon[500];   //[nMuon]
   Float_t         pfCandChargedIso04Muon[500];   //[nMuon]
   Float_t         pfCandNeutralIso04Muon[500];   //[nMuon]
   Float_t         pfCandPhotonIso04Muon[500];   //[nMuon]
   Float_t         pfCandChargedDirIso04Muon[500];   //[nMuon]
   Float_t         pfCandNeutralDirIso04Muon[500];   //[nMuon]
   Float_t         pfCandPhotonDirIso04Muon[500];   //[nMuon]
   Float_t         pfIsolationSumPUPtR03Muon[500];   //[nMuon]
   Float_t         pfIsolationSumPUPtR04Muon[500];   //[nMuon]
   Float_t         pfCandChargedPUIso03Muon[500];   //[nMuon]
   Float_t         pfCandChargedPUIso04Muon[500];   //[nMuon]
   Float_t         kinkMuon[500];   //[nMuon]
   Float_t         mvaisoMuon[500];   //[nMuon]
   Float_t         scaledMomentumMuon[500];   //[nMuon]
   Int_t           nPFCand;
