...
// Tue Dec  3 15:31:10 2013 by ROOT version 5.34/11
// from TTree ntp1/ntp1
// found on file: /Users/emanuele/Work/data/vecbos/default_MC_255_1_svD.root
//////////////////////////////////////////////////////////

#ifndef VecbosEventContent_h
#define VecbosEventContent_h
...
public :
   ...
   Int_t           nTrg;
   Int_t           firedTrg[10000];   //[nTrg]
   Int_t           nHLT;
   Int_t           indexHLT[10000];   //[nHLT]
   std::vector<std::string>  *nameHLT;
   Int_t           nTriggerPaths;
   Int_t           nTriggerObsPassing;
   Int_t           sizePassing[10000];   //[nTriggerPaths]
   Int_t           indexPassing[10000];   //[nTriggerObsPassing]
   Int_t           indexPassingPerPath[10000];   //[nTriggerPaths]
   Int_t           nTriggerObs;
   Float_t         triggerObsPt[10000];   //[nTriggerObs]
   Float_t         triggerObsPhi[10000];   //[nTriggerObs]
   Float_t         triggerObsEta[10000];   //[nTriggerObs]
   Float_t         triggerObsMass[10000];   //[nTriggerObs]
   Int_t           nEle;
   Int_t           chargeEle[1000];   //[nEle]
   Float_t         energyEle[1000];   //[nEle]
   Float_t         thetaEle[1000];   //[nEle]
   Float_t         etaEle[1000];   //[nEle]
   Float_t         phiEle[1000];   //[nEle]
   Float_t         pxEle[1000];   //[nEle]
   Float_t         pyEle[1000];   //[nEle]
   Float_t         pzEle[1000];   //[nEle]
   Float_t         vertexXEle[1000];   //[nEle]
   Float_t         vertexYEle[1000];   //[nEle]
   Float_t         vertexZEle[1000];   //[nEle]
   Int_t           fiducialFlagsEle[1000];   //[nEle]
   Int_t           recoFlagsEle[1000];   //[nEle]
   Float_t         trackMomentumErrorEle[1000];   //[nEle]
   Int_t           superClusterIndexEle[1000];   //[nEle]
   Int_t           PFsuperClusterIndexEle[1000];   //[nEle]
   Int_t           trackIndexEle[1000];   //[nEle]
   Int_t           gsfTrackIndexEle[1000];   //[nEle]
   Float_t         convDistEle[1000];   //[nEle]
   Float_t         convDcotEle[1000];   //[nEle]
   Float_t         convRadiusEle[1000];   //[nEle]
   Int_t           convTrackIndexEle[1000];   //[nEle]
   Int_t           scPixChargeEle[1000];   //[nEle]
   Bool_t          hasMatchedConversionEle[1000];   //[nEle]
   Int_t           classificationEle[1000];   //[nEle]
   Float_t         fbremEle[1000];   //[nEle]
   Int_t           nbremsEle[1000];   //[nEle]
   Float_t         hOverEEle[1000];   //[nEle]
   Float_t         eSuperClusterOverPEle[1000];   //[nEle]
   Float_t         eSeedOverPoutEle[1000];   //[nEle]
   Float_t         eEleClusterOverPoutEle[1000];   //[nEle]
   Float_t         deltaEtaAtVtxEle[1000];   //[nEle]
   Float_t         deltaPhiAtVtxEle[1000];   //[nEle]
   Float_t         deltaEtaAtCaloEle[1000];   //[nEle]
   Float_t         deltaPhiAtCaloEle[1000];   //[nEle]
   Float_t         deltaEtaEleClusterTrackAtCaloEle[1000];   //[nEle]
   Float_t         deltaPhiEleClusterTrackAtCaloEle[1000];   //[nEle]
   Float_t         dr03TkSumPtEle[1000];   //[nEle]
   Float_t         dr03EcalRecHitSumEtEle[1000];   //[nEle]
   Float_t         dr03HcalTowerSumEtEle[1000];   //[nEle]
   Float_t         dr04TkSumPtEle[1000];   //[nEle]
   Float_t         dr04EcalRecHitSumEtEle[1000];   //[nEle]
   Float_t         dr04HcalTowerSumEtEle[1000];   //[nEle]
   Float_t         dr03HcalTowerSumEtFullConeEle[1000];   //[nEle]
   Float_t         dr04HcalTowerSumEtFullConeEle[1000];   //[nEle]
   Float_t         pflowMVAEle[1000];   //[nEle]
   Float_t         mvaidnontrigEle[1000];   //[nEle]
   Float_t         mvaidtrigEle[1000];   //[nEle]
   Float_t         mvaidisotrigEle[1000];   //[nEle]
   Float_t         pfCombinedIsoEle[1000];   //[nEle]
   Float_t         pfCandChargedIso03Ele[1000];   //[nEle]
   Float_t         pfCandNeutralIso03Ele[1000];   //[nEle]
   Float_t         pfCandPhotonIso03Ele[1000];   //[nEle]
   Float_t         pfCandChargedIso04Ele[1000];   //[nEle]
   Float_t         pfCandNeutralIso04Ele[1000];   //[nEle]
   Float_t         pfCandPhotonIso04Ele[1000];   //[nEle]
   Float_t         pfCandChargedDirIso04Ele[1000];   //[nEle]
   Float_t         pfCandNeutralDirIso04Ele[1000];   //[nEle]
   Float_t         pfCandPhotonDirIso04Ele[1000];   //[nEle]
   Float_t         pfCandChargedPUIso03Ele[1000];   //[nEle]
   Float_t         pfCandChargedPUIso04Ele[1000];   //[nEle]
   Float_t         calibEnergyEle[1000];   //[nEle]
   Float_t         calibEnergyErrorEle[1000];   //[nEle]
   Int_t           nPho;
   Int_t           nPerPVPho;
   Int_t           chargePho[1000];   //[nPho]
   Float_t         energyPho[1000];   //[nPho]
   Float_t         thetaPho[1000];   //[nPho]
   Float_t         etaPho[1000];   //[nPho]
   Float_t         phiPho[1000];   //[nPho]
   Float_t         pxPho[1000];   //[nPho]
   Float_t         pyPho[1000];   //[nPho]
   Float_t         pzPho[1000];   //[nPho]
   Float_t         vertexXPho[1000];   //[nPho]
   Float_t         vertexYPho[1000];   //[nPho]
   Float_t         vertexZPho[1000];   //[nPho]
   Int_t           fiducialFlagsPho[1000];   //[nPho]
   Int_t           recoFlagsPho[1000];   //[nPho]
   Int_t           superClusterIndexPho[1000];   //[nPho]
   Int_t           PFsuperClusterIndexPho[1000];   //[nPho]
   Float_t         hOverEPho[1000];   //[nPho]
   Float_t         hTowOverEPho[1000];   //[nPho]
   Float_t         dr03TkSumPtPho[1000];   //[nPho]
   Float_t         dr03HollowTkSumPtPho[1000];   //[nPho]
   Float_t         dr03EcalRecHitSumEtPho[1000];   //[nPho]
   Float_t         dr03HcalTowerSumEtPho[1000];   //[nPho]
   Float_t         dr04TkSumPtPho[1000];   //[nPho]
   Float_t         dr04HollowTkSumPtPho[1000];   //[nPho]
   Float_t         dr04EcalRecHitSumEtPho[1000];   //[nPho]
   Float_t         dr04HcalTowerSumEtPho[1000];   //[nPho]
   Float_t         chargedHadronIsoPho[1000];   //[nPho]
   Float_t         neutralHadronIsoPho[1000];   //[nPho]
   Float_t         photonIsoPho[1000];   //[nPho]
   Int_t           hasPixelSeedPho[1000];   //[nPho]
   Bool_t          hasMatchedConversionPho[1000];   //[nPho]
   Float_t         dr02NeutralHadronPFIsoPho[1000];   //[nPho]
   Float_t         dr02PhotonPFIsoPho[1000];   //[nPho]
   Float_t         dr03NeutralHadronPFIsoPho[1000];   //[nPho]
   Float_t         dr03PhotonPFIsoPho[1000];   //[nPho]
   Float_t         dr04NeutralHadronPFIsoPho[1000];   //[nPho]
   Float_t         dr04PhotonPFIsoPho[1000];   //[nPho]
   Float_t         dr02ChargedHadronPFIsoPho[1000];   //[nPerPVPho]
   Float_t         dr03ChargedHadronPFIsoPho[1000];   //[nPerPVPho]
   Float_t         dr04ChargedHadronPFIsoPho[1000];   //[nPerPVPho]
   Int_t           nSC;
   Int_t           nBCSC[10000];   //[nSC]
   Int_t           nCrystalsSC[10000];   //[nSC]
   Float_t         rawEnergySC[10000];   //[nSC]
   Float_t         energySC[10000];   //[nSC]
   Float_t         seedClusterEnergySC[10000];   //[nSC]
   Float_t         esEnergySC[10000];   //[nSC]
   Float_t         etaSC[10000];   //[nSC]
   Float_t         thetaSC[10000];   //[nSC]
   Float_t         phiSC[10000];   //[nSC]
   Float_t         xPosSC[10000];   //[nSC]
   Float_t         yPosSC[10000];   //[nSC]
   Float_t         zPosSC[10000];   //[nSC]
   Float_t         phiWidthSC[10000];   //[nSC]
   Float_t         etaWidthSC[10000];   //[nSC]
   Float_t         e3x3SC[10000];   //[nSC]
   Float_t         e3x1SC[10000];   //[nSC]
   Float_t         e1x3SC[10000];   //[nSC]
   Float_t         e4x4SC[10000];   //[nSC]
   Float_t         e5x5SC[10000];   //[nSC]
   Float_t         eMaxSC[10000];   //[nSC]
   Float_t         e2x2SC[10000];   //[nSC]
   Float_t         e2ndSC[10000];   //[nSC]
   Float_t         e1x5SC[10000];   //[nSC]
   Float_t         e2x5MaxSC[10000];   //[nSC]
   Float_t         e2x5LeftSC[10000];   //[nSC]
   Float_t         e2x5RightSC[10000];   //[nSC]
   Float_t         e2x5TopSC[10000];   //[nSC]
   Float_t         e2x5BottomSC[10000];   //[nSC]
   Float_t         eLeftSC[10000];   //[nSC]
   Float_t         eRightSC[10000];   //[nSC]
   Float_t         eTopSC[10000];   //[nSC]
   Float_t         eBottomSC[10000];   //[nSC]
   Float_t         e4SwissCrossSC[10000];   //[nSC]
   Float_t         covIEtaIEtaSC[10000];   //[nSC]
   Float_t         covIEtaIPhiSC[10000];   //[nSC]
   Float_t         covIPhiIPhiSC[10000];   //[nSC]
   Float_t         hOverESC[10000];   //[nSC]
   Float_t         seedEnergySC[10000];   //[nSC]
   Float_t         seedXSC[10000];   //[nSC]
   Float_t         seedYSC[10000];   //[nSC]
   Float_t         esEffsIxIxSC[10000];   //[nSC]
   Float_t         esEffsIyIySC[10000];   //[nSC]
   Float_t         esL1EnergySC[10000];   //[nSC]
   Float_t         esL2EnergySC[10000];   //[nSC]
   Int_t           esL1StripsSC[10000];   //[nSC]
   Int_t           esL2StripsSC[10000];   //[nSC]
   Int_t           nPFSC;
   Int_t           nBCPFSC[10000];   //[nPFSC]
   Int_t           nCrystalsPFSC[10000];   //[nPFSC]
   Float_t         rawEnergyPFSC[10000];   //[nPFSC]
   Float_t         energyPFSC[10000];   //[nPFSC]
   Float_t         seedClusterEnergyPFSC[10000];   //[nPFSC]
   Float_t         esEnergyPFSC[10000];   //[nPFSC]
   Float_t         etaPFSC[10000];   //[nPFSC]
   Float_t         thetaPFSC[10000];   //[nPFSC]
   Float_t         phiPFSC[10000];   //[nPFSC]
   Float_t         xPosPFSC[10000];   //[nPFSC]
   Float_t         yPosPFSC[10000];   //[nPFSC]
   Float_t         zPosPFSC[10000];   //[nPFSC]
   Float_t         phiWidthPFSC[10000];   //[nPFSC]
   Float_t         etaWidthPFSC[10000];   //[nPFSC]
   Float_t         e3x3PFSC[10000];   //[nPFSC]
   Float_t         e3x1PFSC[10000];   //[nPFSC]
   Float_t         e1x3PFSC[10000];   //[nPFSC]
   Float_t         e4x4PFSC[10000];   //[nPFSC]
   Float_t         e5x5PFSC[10000];   //[nPFSC]
   Float_t         eMaxPFSC[10000];   //[nPFSC]
   Float_t         e2x2PFSC[10000];   //[nPFSC]
   Float_t         e2ndPFSC[10000];   //[nPFSC]
   Float_t         e1x5PFSC[10000];   //[nPFSC]
   Float_t         e2x5MaxPFSC[10000];   //[nPFSC]
   Float_t         e2x5LeftPFSC[10000];   //[nPFSC]
   Float_t         e2x5RightPFSC[10000];   //[nPFSC]
   Float_t         e2x5TopPFSC[10000];   //[nPFSC]
   Float_t         e2x5BottomPFSC[10000];   //[nPFSC]
   Float_t         eLeftPFSC[10000];   //[nPFSC]
   Float_t         eRightPFSC[10000];   //[nPFSC]
   Float_t         eTopPFSC[10000];   //[nPFSC]
   Float_t         eBottomPFSC[10000];   //[nPFSC]
   Float_t         e4SwissCrossPFSC[10000];   //[nPFSC]
   Float_t         covIEtaIEtaPFSC[10000];   //[nPFSC]
   Float_t         covIEtaIPhiPFSC[10000];   //[nPFSC]
   Float_t         covIPhiIPhiPFSC[10000];   //[nPFSC]
   Float_t         hOverEPFSC[10000];   //[nPFSC]
   Float_t         seedEnergyPFSC[10000];   //[nPFSC]
   Float_t         seedXPFSC[10000];   //[nPFSC]
   Float_t         seedYPFSC[10000];   //[nPFSC]
   Float_t         esEffsIxIxPFSC[10000];   //[nPFSC]
   Float_t         esEffsIyIyPFSC[10000];   //[nPFSC]
   Float_t         esL1EnergyPFSC[10000];   //[nPFSC]
   Float_t         esL2EnergyPFSC[10000];   //[nPFSC]
   Int_t           esL1StripsPFSC[10000];   //[nPFSC]
   Int_t           esL2StripsPFSC[10000];   //[nPFSC]
   Int_t           nTrack;
   ...
   Float_t         impactPar3DBiasedTrack[1000];   //[nTrack]
   Float_t         impactPar3DBiasedErrorTrack[1000];   //[nTrack]
   Float_t         transvImpactParBiasedTrack[1000];   //[nTrack]
   Float_t         transvImpactParBiasedErrorTrack[1000];   //[nTrack]
   ...
   Float_t         d0Track[1000];   //[nTrack]
   Float_t         d0ErrorTrack[1000];   //[nTrack]
   Float_t         dzTrack[1000];   //[nTrack]
   Float_t         dzErrorTrack[1000];   //[nTrack]
   Int_t           pixelHitsTrack[1000];   //[nTrack]
   Int_t           trackerLayersWithMeasurementTrack[1000];   //[nTrack]
   ...
   Int_t           numberOfValidMuonHitsTrack[1000];   //[nTrack]
   Int_t           nGsfTrack;
   Float_t         pxGsfTrack[1000];   //[nGsfTrack]
   Float_t         pyGsfTrack[1000];   //[nGsfTrack]
   Float_t         pzGsfTrack[1000];   //[nGsfTrack]
   Int_t           vtxIndexGsfTrack[1000];   //[nGsfTrack]
   Float_t         vtxWeightGsfTrack[1000];   //[nGsfTrack]
   Float_t         impactPar3DGsfTrack[1000];   //[nGsfTrack]
   Float_t         impactPar3DErrorGsfTrack[1000];   //[nGsfTrack]
   Float_t         transvImpactParGsfTrack[1000];   //[nGsfTrack]
   Float_t         transvImpactParErrorGsfTrack[1000];   //[nGsfTrack]
   Float_t         impactPar3DBiasedGsfTrack[1000];   //[nGsfTrack]
   Float_t         impactPar3DBiasedErrorGsfTrack[1000];   //[nGsfTrack]
   Float_t         transvImpactParBiasedGsfTrack[1000];   //[nGsfTrack]
   Float_t         transvImpactParBiasedErrorGsfTrack[1000];   //[nGsfTrack]
   Float_t         chargeGsfTrack[1000];   //[nGsfTrack]
   Float_t         ptErrorGsfTrack[1000];   //[nGsfTrack]
   Float_t         trackValidHitsGsfTrack[1000];   //[nGsfTrack]
   Float_t         trackLostHitsGsfTrack[1000];   //[nGsfTrack]
   Float_t         trackNormalizedChi2GsfTrack[1000];   //[nGsfTrack]
   Int_t           qualityMaskGsfTrack[1000];   //[nGsfTrack]
   Float_t         trackVxGsfTrack[1000];   //[nGsfTrack]
   Float_t         trackVyGsfTrack[1000];   //[nGsfTrack]
   Float_t         trackVzGsfTrack[1000];   //[nGsfTrack]
   Float_t         d0GsfTrack[1000];   //[nGsfTrack]
   Float_t         d0ErrorGsfTrack[1000];   //[nGsfTrack]
   Float_t         dzGsfTrack[1000];   //[nGsfTrack]
   Float_t         dzErrorGsfTrack[1000];   //[nGsfTrack]
   Int_t           pixelHitsGsfTrack[1000];   //[nGsfTrack]
   Int_t           trackerLayersWithMeasurementGsfTrack[1000];   //[nGsfTrack]
   Int_t           expInnerLayersGsfTrack[1000];   //[nGsfTrack]
   Int_t           numberOfValidPixelBarrelHitsGsfTrack[1000];   //[nGsfTrack]
   Int_t           numberOfValidPixelEndcapHitsGsfTrack[1000];   //[nGsfTrack]
   Int_t           numberOfValidStripTIBHitsGsfTrack[1000];   //[nGsfTrack]
   Int_t           numberOfValidStripTIDHitsGsfTrack[1000];   //[nGsfTrack]
   Int_t           numberOfValidStripTOBHitsGsfTrack[1000];   //[nGsfTrack]
   Int_t           numberOfValidStripTECHitsGsfTrack[1000];   //[nGsfTrack]
   Int_t           numberOfValidMuonHitsGsfTrack[1000];   //[nGsfTrack]
   Int_t           chargeModeGsfTrack[1000];   //[nGsfTrack]
   Float_t         pxModeGsfTrack[1000];   //[nGsfTrack]
   Float_t         pyModeGsfTrack[1000];   //[nGsfTrack]
   Float_t         pzModeGsfTrack[1000];   //[nGsfTrack]
   Int_t           nGlobalMuonTrack;
   Float_t         pxGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Float_t         pyGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Float_t         pzGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Int_t           vtxIndexGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Float_t         vtxWeightGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Float_t         impactPar3DGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Float_t         impactPar3DErrorGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Float_t         transvImpactParGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Float_t         transvImpactParErrorGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Float_t         impactPar3DBiasedGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Float_t         impactPar3DBiasedErrorGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Float_t         transvImpactParBiasedGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Float_t         transvImpactParBiasedErrorGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Float_t         chargeGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Float_t         ptErrorGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Float_t         trackValidHitsGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Float_t         trackLostHitsGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Float_t         trackNormalizedChi2GlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Int_t           qualityMaskGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Float_t         trackVxGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Float_t         trackVyGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Float_t         trackVzGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Float_t         d0GlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Float_t         d0ErrorGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Float_t         dzGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Float_t         dzErrorGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Int_t           pixelHitsGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Int_t           trackerLayersWithMeasurementGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Int_t           expInnerLayersGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Int_t           numberOfValidPixelBarrelHitsGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Int_t           numberOfValidPixelEndcapHitsGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Int_t           numberOfValidStripTIBHitsGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Int_t           numberOfValidStripTIDHitsGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Int_t           numberOfValidStripTOBHitsGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Int_t           numberOfValidStripTECHitsGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Int_t           numberOfValidMuonHitsGlobalMuonTrack[1000];   //[nGlobalMuonTrack]
   Int_t           nSTAMuonTrack;
   Float_t         pxSTAMuonTrack[1000];   //[nSTAMuonTrack]
   Float_t         pySTAMuonTrack[1000];   //[nSTAMuonTrack]
   Float_t         pzSTAMuonTrack[1000];   //[nSTAMuonTrack]
   Float_t         chargeSTAMuonTrack[1000];   //[nSTAMuonTrack]
   Float_t         ptErrorSTAMuonTrack[1000];   //[nSTAMuonTrack]
   Float_t         trackValidHitsSTAMuonTrack[1000];   //[nSTAMuonTrack]
   Float_t         trackLostHitsSTAMuonTrack[1000];   //[nSTAMuonTrack]
   Float_t         trackNormalizedChi2STAMuonTrack[1000];   //[nSTAMuonTrack]
   Int_t           qualityMaskSTAMuonTrack[1000];   //[nSTAMuonTrack]
   Float_t         trackVxSTAMuonTrack[1000];   //[nSTAMuonTrack]
   Float_t         trackVySTAMuonTrack[1000];   //[nSTAMuonTrack]
   Float_t         trackVzSTAMuonTrack[1000];   //[nSTAMuonTrack]
   Float_t         d0STAMuonTrack[1000];   //[nSTAMuonTrack]
   Float_t         d0ErrorSTAMuonTrack[1000];   //[nSTAMuonTrack]
   Float_t         dzSTAMuonTrack[1000];   //[nSTAMuonTrack]
   Float_t         dzErrorSTAMuonTrack[1000];   //[nSTAMuonTrack]
   Int_t           pixelHitsSTAMuonTrack[1000];   //[nSTAMuonTrack]
   Int_t           trackerLayersWithMeasurementSTAMuonTrack[1000];   //[nSTAMuonTrack]
   Int_t           expInnerLayersSTAMuonTrack[1000];   //[nSTAMuonTrack]
   Int_t           numberOfValidPixelBarrelHitsSTAMuonTrack[1000];   //[nSTAMuonTrack]
   Int_t           numberOfValidPixelEndcapHitsSTAMuonTrack[1000];   //[nSTAMuonTrack]
   Int_t           numberOfValidStripTIBHitsSTAMuonTrack[1000];   //[nSTAMuonTrack]
   Int_t           numberOfValidStripTIDHitsSTAMuonTrack[1000];   //[nSTAMuonTrack]
   Int_t           numberOfValidStripTOBHitsSTAMuonTrack[1000];   //[nSTAMuonTrack]
   Int_t           numberOfValidStripTECHitsSTAMuonTrack[1000];   //[nSTAMuonTrack]
   Int_t           numberOfValidMuonHitsSTAMuonTrack[1000];   //[nSTAMuonTrack]
   Int_t           nPV;
   Float_t         PVxPV[1000];   //[nPV]
   Float_t         PVyPV[1000];   //[nPV]
   Float_t         PVzPV[1000];   //[nPV]
   Float_t         PVErrxPV[1000];   //[nPV]
   Float_t         PVErryPV[1000];   //[nPV]
   Float_t         PVErrzPV[1000];   //[nPV]
   Float_t         SumPtPV[1000];   //[nPV]
   Float_t         rhoPV[1000];   //[nPV]
   Float_t         ndofPV[1000];   //[nPV]
   Float_t         chi2PV[1000];   //[nPV]
   Float_t         normChi2PV[1000];   //[nPV]
   Float_t         pxChMetPV[1000];   //[nPV]
   Float_t         pyChMetPV[1000];   //[nPV]
   Float_t         pzChMetPV[1000];   //[nPV]
   Int_t           isFakePV[1000];   //[nPV]
   Int_t           isValidPV[1000];   //[nPV]
   Int_t           trackSizePV[1000];   //[nPV]
   Int_t           nMuon;
   Int_t           chargeMuon[1000];   //[nMuon]
   Float_t         energyMuon[1000];   //[nMuon]
   Float_t         thetaMuon[1000];   //[nMuon]
   Float_t         etaMuon[1000];   //[nMuon]
   Float_t         phiMuon[1000];   //[nMuon]
   Float_t         pxMuon[1000];   //[nMuon]
   Float_t         pyMuon[1000];   //[nMuon]
   Float_t         pzMuon[1000];   //[nMuon]
   Float_t         vertexXMuon[1000];   //[nMuon]
   Float_t         vertexYMuon[1000];   //[nMuon]
   Float_t         vertexZMuon[1000];   //[nMuon]
   Int_t           trackIndexMuon[1000];   //[nMuon]
   Int_t           standAloneTrackIndexMuon[1000];   //[nMuon]
   Int_t           combinedTrackIndexMuon[1000];   //[nMuon]
   Int_t           muonIdMuon[1000];   //[nMuon]
   Bool_t          pfmuonIdMuon[1000];   //[nMuon]
   Int_t           typeMuon[1000];   //[nMuon]
   Int_t           numberOfMatchesMuon[1000];   //[nMuon]
   Float_t         sumPt03Muon[1000];   //[nMuon]
   Float_t         emEt03Muon[1000];   //[nMuon]
   Float_t         hadEt03Muon[1000];   //[nMuon]
   Float_t         hoEt03Muon[1000];   //[nMuon]
   Float_t         nTrk03Muon[1000];   //[nMuon]
   Float_t         nJets03Muon[1000];   //[nMuon]
   Float_t         sumPt05Muon[1000];   //[nMuon]
   Float_t         emEt05Muon[1000];   //[nMuon]
   Float_t         hadEt05Muon[1000];   //[nMuon]
   Float_t         hoEt05Muon[1000];   //[nMuon]
   Float_t         nTrk05Muon[1000];   //[nMuon]
   Float_t         nJets05Muon[1000];   //[nMuon]
   Float_t         pfCombinedIsoMuon[1000];   //[nMuon]
   Float_t         pfCandChargedIso03Muon[1000];   //[nMuon]
   Float_t         pfCandNeutralIso03Muon[1000];   //[nMuon]
   Float_t         pfCandPhotonIso03Muon[1000];   //[nMuon]
   Float_t         pfCandChargedIso04Muon[1000];   //[nMuon]
   Float_t         pfCandNeutralIso04Muon[1000];   //[nMuon]
   Float_t         pfCandPhotonIso04Muon[1000];   //[nMuon]
   Float_t         pfCandChargedDirIso04Muon[1000];   //[nMuon]
   Float_t         pfCandNeutralDirIso04Muon[1000];   //[nMuon]
   Float_t         pfCandPhotonDirIso04Muon[1000];   //[nMuon]
   Float_t         pfIsolationSumPUPtR03Muon[1000];   //[nMuon]
   Float_t         pfIsolationSumPUPtR04Muon[1000];   //[nMuon]
   Float_t         pfCandChargedPUIso03Muon[1000];   //[nMuon]
   Float_t         pfCandChargedPUIso04Muon[1000];   //[nMuon]
   Float_t         kinkMuon[1000];   //[nMuon]
   Float_t         mvaisoMuon[1000];   //[nMuon]
   Float_t         scaledMomentumMuon[1000];   //[nMuon]
   Int_t           nPFCand;
   Int_t           chargePFCand[1000];   //[nPFCand]
   Float_t         energyPFCand[1000];   //[nPFCand]
   Float_t         thetaPFCand[1000];   //[nPFCand]
   Float_t         etaPFCand[1000];   //[nPFCand]
   Float_t         phiPFCand[1000];   //[nPFCand]
   Float_t         pxPFCand[1000];   //[nPFCand]
   Float_t         pyPFCand[1000];   //[nPFCand]
   Float_t         pzPFCand[1000];   //[nPFCand]
   Float_t         vertexXPFCand[1000];   //[nPFCand]
   Float_t         vertexYPFCand[1000];   //[nPFCand]
   Float_t         vertexZPFCand[1000];   //[nPFCand]
   Int_t           particleIdPFCand[1000];   //[nPFCand]
   Double_t        ChargedIso03PFCand[1000];   //[nPFCand]
   Double_t        NeutralIso03PFCand[1000];   //[nPFCand]
   Double_t        PhotonIso03PFCand[1000];   //[nPFCand]
   Double_t        SumPUPtR03PFCand[1000];   //[nPFCand]
   Int_t           nReducedPFCand;
   Int_t           chargeReducedPFCand[10000];   //[nReducedPFCand]
   Float_t         energyReducedPFCand[10000];   //[nReducedPFCand]
   Float_t         thetaReducedPFCand[10000];   //[nReducedPFCand]
   Float_t         etaReducedPFCand[10000];   //[nReducedPFCand]
   Float_t         phiReducedPFCand[10000];   //[nReducedPFCand]
   Float_t         pxReducedPFCand[10000];   //[nReducedPFCand]
   Float_t         pyReducedPFCand[10000];   //[nReducedPFCand]
   Float_t         pzReducedPFCand[10000];   //[nReducedPFCand]
   Float_t         vertexXReducedPFCand[10000];   //[nReducedPFCand]
   Float_t         vertexYReducedPFCand[10000];   //[nReducedPFCand]
   Float_t         vertexZReducedPFCand[10000];   //[nReducedPFCand]
   Int_t           nMet;
   ...
   Float_t         axis1AK5PFPUcorrJet[1000];   //[nAK5PFPUcorrJet]
   Float_t         axis2AK5PFPUcorrJet[1000];   //[nAK5PFPUcorrJet]
   Float_t         pullAK5PFPUcorrJet[1000];   //[nAK5PFPUcorrJet]
   Float_t         tanaAK5PFPUcorrJet[1000];   //[nAK5PFPUcorrJet]
   Float_t         rmsCand_QCAK5PFPUcorrJet[1000];   //[nAK5PFPUcorrJet]
   Float_t         ptD_QCAK5PFPUcorrJet[1000];   //[nAK5PFPUcorrJet]
   Float_t         axis1_QCAK5PFPUcorrJet[1000];   //[nAK5PFPUcorrJet]
   Float_t         axis2_QCAK5PFPUcorrJet[1000];   //[nAK5PFPUcorrJet]
   Float_t         pull_QCAK5PFPUcorrJet[1000];   //[nAK5PFPUcorrJet]
   Float_t         tana_QCAK5PFPUcorrJet[1000];   //[nAK5PFPUcorrJet]
   Int_t           nChg_ptCutAK5PFPUcorrJet[1000];   //[nAK5PFPUcorrJet]
   Int_t           nChg_QCAK5PFPUcorrJet[1000];   //[nAK5PFPUcorrJet]
   Int_t           nChg_ptCut_QCAK5PFPUcorrJet[1000];   //[nAK5PFPUcorrJet]
   Int_t           nNeutral_ptCutAK5PFPUcorrJet[1000];   //[nAK5PFPUcorrJet]
   Float_t         RchgAK5PFPUcorrJet[1000];   //[nAK5PFPUcorrJet]
   Float_t         RneutralAK5PFPUcorrJet[1000];   //[nAK5PFPUcorrJet]
   Float_t         RAK5PFPUcorrJet[1000];   //[nAK5PFPUcorrJet]
   Float_t         Rchg_QCAK5PFPUcorrJet[1000];   //[nAK5PFPUcorrJet]
   Float_t         pTMaxAK5PFPUcorrJet[1000];   //[nAK5PFPUcorrJet]
   Float_t         pTMaxChgAK5PFPUcorrJet[1000];   //[nAK5PFPUcorrJet]
   Float_t         pTMaxNeutralAK5PFPUcorrJet[1000];   //[nAK5PFPUcorrJet]
   Float_t         pTMaxChg_QCAK5PFPUcorrJet[1000];   //[nAK5PFPUcorrJet]
   Int_t           nAK5GenJet;
   Int_t           chargeAK5GenJet[1000];   //[nAK5GenJet]
   Float_t         energyAK5GenJet[1000];   //[nAK5GenJet]
   Float_t         thetaAK5GenJet[1000];   //[nAK5GenJet]
   Float_t         etaAK5GenJet[1000];   //[nAK5GenJet]
   Float_t         phiAK5GenJet[1000];   //[nAK5GenJet]
   Float_t         pxAK5GenJet[1000];   //[nAK5GenJet]
   Float_t         pyAK5GenJet[1000];   //[nAK5GenJet]
   Float_t         pzAK5GenJet[1000];   //[nAK5GenJet]
   Float_t         vertexXAK5GenJet[1000];   //[nAK5GenJet]
   Float_t         vertexYAK5GenJet[1000];   //[nAK5GenJet]
   Float_t         vertexZAK5GenJet[1000];   //[nAK5GenJet]
   Double_t        genPtHat;
   ...
   TBranch        *b_etatHMc;   //!
   TBranch        *b_phitHMc;   //!
   TBranch        *b_energytHMc;   //!
   TBranch        *b_idtHMc;   //!
   TBranch        *b_statustHMc;   //!
   TBranch        *b_mothSttHMc;   //!
   TBranch        *b_grandmothSttHMc;   //!
   TBranch        *b_mothIdtHMc;   //!
   TBranch        *b_grandmothIdtHMc;   //!
   TBranch        *b_nTrg;   //!
   TBranch        *b_firedTrg;   //!
   TBranch        *b_nHLT;   //!
   TBranch        *b_indexHLT;   //!
   ...
   VecbosEventContent(TTree *tree=0);
   virtual ~VecbosEventContent();
...
VecbosEventContent::VecbosEventContent(TTree *tree) : fChain(0) 
{
...
VecbosEventContent::~VecbosEventContent()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t VecbosEventContent::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t VecbosEventContent::LoadTree(Long64_t entry)
{
...
void VecbosEventContent::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("ntHMc", &ntHMc, &b_ntHMc);
   fChain->SetBranchAddress("ptHMc", ptHMc, &b_ptHMc);
   fChain->SetBranchAddress("thetatHMc", thetatHMc, &b_thetatHMc);
   fChain->SetBranchAddress("etatHMc", etatHMc, &b_etatHMc);
   fChain->SetBranchAddress("phitHMc", phitHMc, &b_phitHMc);
   fChain->SetBranchAddress("energytHMc", energytHMc, &b_energytHMc);
   fChain->SetBranchAddress("idtHMc", idtHMc, &b_idtHMc);
   fChain->SetBranchAddress("statustHMc", statustHMc, &b_statustHMc);
   fChain->SetBranchAddress("mothSttHMc", mothSttHMc, &b_mothSttHMc);
   fChain->SetBranchAddress("grandmothSttHMc", grandmothSttHMc, &b_grandmothSttHMc);
   fChain->SetBranchAddress("mothIdtHMc", mothIdtHMc, &b_mothIdtHMc);
   fChain->SetBranchAddress("grandmothIdtHMc", grandmothIdtHMc, &b_grandmothIdtHMc);
...
Bool_t VecbosEventContent::Notify()
{
...
void VecbosEventContent::Show(Long64_t entry)
{
...
Int_t VecbosEventContent::Cut(Long64_t entry)
{
