...
class JetCorrector
{
 public:
  ...
  typedef vecbos::Candidate::LorentzVector LorentzVector;
  ...
  virtual double correction (const vecbos::Jet& fJet) const = 0;

  /// apply correction using all event information
  virtual double correction (const vecbos::Jet& fJet,
